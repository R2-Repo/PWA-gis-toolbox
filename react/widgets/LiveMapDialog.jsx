    ...
    return (
        ...
        >
            <p className="live-map-dialog__hint">
                Add live service layers and build a bookmarkable map URL.
            </p>

            <div className="live-map-dialog__section">
                <h4 className="live-map-dialog__section-title">Layer URLs</h4>
            ...
            <div className="live-map-dialog__section">
                <h4 className="live-map-dialog__section-title">Map settings</h4>
            ...
            <div className="live-map-dialog__section live-map-dialog__advanced">
                <button
                    type="button"
                    className="live-map-dialog__advanced-toggle"
                    aria-expanded={advancedOpen}
                    onClick={() => setAdvancedOpen((open) => !open)}
                >
                    <span>Advanced — view &amp; extent</span>
                    <span className="live-map-dialog__advanced-chevron" aria-hidden="true">{advancedOpen ? '▾' : '▸'}</span>
                </button>
                {advancedOpen ? (
                    <div className="live-map-dialog__advanced-body">
            ...
            <div className="live-map-dialog__section">
                ...
                <textarea className="input live-map-dialog__preview" readOnly rows={2} value={previewUrl} />
                <button
                    type="button"
                    className="live-map-dialog__dev-link"
                    onClick={() => handleAction(() => onCopyCatalogEntry?.(form))}
                    disabled={running}
                >
                    Copy catalog entry (developer)
                </button>
            </div>
        </WidgetPanelShell>
    );
